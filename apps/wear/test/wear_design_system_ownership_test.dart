...
void main() {
  test('Wear home presentation has governed visual ownership', () {
    final presentationRoot = Directory('lib/src/home/presentation');
    expect(
      presentationRoot.existsSync(),
      isTrue,
      reason: 'Run this test from apps/wear.',
    );
    ...
    expect(
      violations,
      isEmpty,
      reason: 'Slice G Wear visual ownership violations:\n${violations.join('\n')}',
    );
  });
}
