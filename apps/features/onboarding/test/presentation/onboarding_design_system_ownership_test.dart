...
void main() {
  test('Product Onboarding presentation has governed visual ownership', () {
    final presentationRoot = Directory('lib/src/presentation');
    expect(
      presentationRoot.existsSync(),
      isTrue,
      reason: 'Run this test from apps/features/onboarding.',
    );
    ...
    expect(
      violations,
      isEmpty,
      reason: 'Slice E visual ownership violations:\n${violations.join('\n')}',
    );
  });
}
