          ...
          child: Column(
            ...
            children: [
              ...
              _ThemeOptionTile(
                ...
                title: 'Dark',
                subtitle: 'Pure black appearance',
              ...
              const SizedBox(height: TioSize.dp10),
              _ThemeOptionTile(
                key: const ValueKey('theme-option-tio-dark'),
                mode: TioThemeMode.tioDark,
                title: 'Tio Dark',
                subtitle: "Tio's signature midnight navy theme",
                icon: Icons.brightness_2_rounded,
                isSelected: _selectedMode == TioThemeMode.tioDark,
                isUpdating: _isUpdating,
                onTap: () => _handleModeSelect(TioThemeMode.tioDark),
              ),
            ],
          ),
        ),
