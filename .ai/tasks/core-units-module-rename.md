...
**Status:** Validated historical source; new consolidation validation tracked separately
**Issue:** #23
...
This record preserves PR #132 provenance at
`2b82722b2097d3d81399f62f89b37eff304b6209`; it does not claim that this
standalone head or the new consolidation tree is independently full-suite green.
Historical full green evidence below belongs to the combined #136 tree.

Current integration is tracked in
[Phase 3A units consolidation](github-stack-consolidation-phase-3a-units.md).
It imports the effective parent-to-head net diff onto PR #152 at
`5d44c1abf8682247e5eabe1081ca905f722910ee`. The two #136 Auth test fixes are
already present there and are not imported again. New validation results belong
in the current consolidation brief, not in this historical evidence section.
