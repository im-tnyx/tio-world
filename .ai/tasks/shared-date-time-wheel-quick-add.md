...
**Status:** In progress
**Primary owner:** pps/core reusable picker + pps/features/nutrition Quick Add adapter/presentation
...
**Implementation SHA:** `b461bc9a706b8c83e29f8f20387ca43b174092b2`
...
**Validation completed at SHA:** Pending exact-head CI
**Validation remaining:** Exact-head CI run verification and owner/device screenshot acceptance
...
**Next exact action:** Push commit to existing branch codex/shared-date-time-wheel-quick-add, verify CI, update PR body, keep Draft pending owner device UI acceptance.

## Global UI / Design-System Guardrail

The validated design-system ownership task and pps/core/lib/src/theme/README.md were inspected before source changes. Existing Tio geometry, semantic theme roles, cards, editor-sheet behavior, calendar asset treatment, and wheel tokens remain authoritative.
...
- pps/core/lib/src/ui/components/pickers/tio_date_time_wheel_picker.dart
- pps/core/lib/src/ui/components/sheets/tio_editor_sheet.dart
- pps/core/test/ui/components/tio_date_time_wheel_picker_test.dart
- pps/features/nutrition/lib/src/meal_diary/presentation/pages/meal_diary_page.dart
- pps/features/nutrition/lib/src/meal_logging/presentation/widgets/meal_log_action_footer.dart
- pps/features/nutrition/lib/src/meal_logging/presentation/widgets/quick_add_editor_sheet.dart
- pps/features/nutrition/test/meal_logging/meal_diary_add_food_flow_test.dart
