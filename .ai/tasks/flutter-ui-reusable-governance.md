...
- `.ai/tasks/README.md` already mandates UI governance, but its explicit theme README/nested-agent step is phrased for normal feature UI rather than all Flutter production UI.
- `.ai/tasks/TEMPLATE.md` requires the design-system consolidation brief for any Flutter UI work, but does not explicitly repeat the theme README + reusable-first lookup order.
...
- [ ] Strengthen root `AGENTS.md` Flutter UI rules.
- [ ] Broaden `.ai/tasks/README.md` mandatory UI governance wording.
- [ ] Add reusable-first/theme README rule to `.ai/tasks/TEMPLATE.md`.
- [ ] Review final diff for duplication/conflicts.
- [ ] Validate and update this task status.
...
None expected beyond documentation enforcement relying on agents honoring checked-in instructions.
