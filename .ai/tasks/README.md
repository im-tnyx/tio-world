...
| [TNYX-259 W1A1 — Canonical Workout identity value objects](tnyx-259-w1a1-workout-identity-value-objects.md) | In progress | `apps/shared` | `ExerciseRef` (catalog `ex_*` / user-created UUID) + `TrainingPlanId`/`PlannedWorkoutId`/`WorkoutSessionId`; implementation separately gated |
