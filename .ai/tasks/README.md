...
| [TNYX-274 W3A2a-F2 — Exercise catalog media](tnyx-274-w3a2a-f2-catalog-media.md) | In progress | `apps/shared` media value + `apps/features/workout` catalog/parser | GitHub #342; curated per-gender media URLs + shared selection rule; no UI; blocks TNYX-272 |
