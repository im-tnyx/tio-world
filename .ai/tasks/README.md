...
| [TNYX-201 B6 — Body + Wellness composition split](tnyx-201-b6-body-wellness-composition.md) | In progress | `apps/app` composition root | GitHub #374; extract app-shell Body/Wellness composition while preserving `network_providers.dart` compatibility |
