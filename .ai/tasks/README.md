...
| [Product Onboarding Slice 2B — Target Weight + Goal Pace](product-onboarding-slice-2b-target-weight-goal-pace.md) | In progress | `apps/features/onboarding` | Canonical PR #50; Target Weight B1 validated by CI #1079; next unblocked work is Goal Pace ownership/default semantics |
