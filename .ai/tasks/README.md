...
| [TNYX-273 W3A2a-F1 — Post-merge catalog review fixes](tnyx-273-w3a2a-post-merge-review-fixes.md) | In progress | `apps/features/workout` catalog source + canonical docs | PR #339 follow-up: stale docs (R4) and narrowed missing-asset classification (R5); no UI/routing/content change |
