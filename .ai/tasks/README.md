...
| [TNYX-269 W3A1 — Exercise catalog data foundation](tnyx-269-w3a1-exercise-catalog-data-foundation.md) | In progress | `apps/features/workout` (domain/data) | W3A1 under TNYX-261; synthetic fixtures only; no asset move/registration, UI, routing, media or standards |
