...
| [TNYX-201 C2b1 — Account Setup route extraction](tnyx-201-c2b1-account-setup-routes.md) | In progress | `apps/app` routing composition | GitHub #383 / #357; extract Account Setup route composition while preserving root lifecycle ownership |
