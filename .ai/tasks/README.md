...
| [GitHub #24 Phase #24-B — Nutrition numeric input migration](issue-24b-nutrition-numeric-input-migration.md) | In progress | `apps/core` input contract + Nutrition presentation | This bounded two-editor migration and its validation/PR handoff |
