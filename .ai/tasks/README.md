...
| [TNYX-201 B5 — Nutrition composition split](tnyx-201-b5-nutrition-composition.md) | In progress | `apps/app` composition root | GitHub #371; extract app-shell Nutrition composition while preserving `network_providers.dart` compatibility |
