...
| [Product Onboarding Slice 2B — Target Weight + Goal Pace](product-onboarding-slice-2b-target-weight-goal-pace.md) | In progress | `apps/features/onboarding` | Canonical PR #50; B1 validated CI #1079 and Goal Pace 2B-C validated CI #1090; next unblocked work is 2B-D integrated acceptance |
