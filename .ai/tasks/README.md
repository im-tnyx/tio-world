...
| [TNYX-201 B4 — Onboarding composition split](tnyx-201-b4-onboarding-composition.md) | In progress | `apps/app` composition root | GitHub #368; extract app-shell Onboarding composition while preserving `network_providers.dart` compatibility |
