...
| [GitHub #403 — Security-check governance](issue-403-security-check-governance.md) | In progress | repository AI/governance + Supabase/protected-server validation | Define agent-readable security-check triggers/failure classification; docs-only |
