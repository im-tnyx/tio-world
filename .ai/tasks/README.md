...
| [TNYX-260 W1A2 — Canonical Exercise read model](tnyx-260-w1a2-canonical-exercise-read-model.md) | In progress | `apps/shared` | One pure-Dart `Exercise` over W1A1 `ExerciseRef`; no catalog loader, persistence, UI, or owner-asset change |
