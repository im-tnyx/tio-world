...
| [TNYX-201 C2a — Auth route group extraction](tnyx-201-c2a-auth-routes.md) | In progress | `apps/app` routing composition | GitHub #380 / #357; extract Auth/pre-auth route composition while preserving root router authority |
