...
| [Product Onboarding Slice 2B — Target Weight + Goal Pace](product-onboarding-slice-2b-target-weight-goal-pace.md) | In progress | `apps/features/onboarding` | Canonical PR #50; B1 audit complete, decide Target Weight direction association/opposite-direction persistence before implementation |
