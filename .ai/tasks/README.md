...
| [TNYX-201 C1 — Router shell extraction](tnyx-201-c1-router-shell.md) | In progress | `apps/app` routing composition | GitHub #377 / #357; extract shell composition while preserving one `goRouterProvider` owner |
