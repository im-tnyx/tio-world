...
| [TNYX-258 W1A7 — Stale shared Workout scaffold cleanup](tnyx-258-w1a7-stale-workout-scaffold-cleanup.md) | In progress | `apps/shared` | Deletion-only; delete the 11 audited `apps/shared` Workout scaffold files before W1A1, after owner implementation authorization |
