...
| [Workout Library / Exercises / Explore IA reconciliation](workout-library-exercises-ia-reconciliation.md) | In progress | Workout planning docs + Linear roadmap | Planning/docs only; one canonical Library route, dedicated Exercises screen, Exercises before Explore |
