...
| [TNYX-271 — App startup path organization](tnyx-271-app-startup-organization.md) | In progress | `apps/app` startup/composition root | GitHub #337; path-only grouping of startup runtime files, no behavior/UI/schema change |
| [TNYX-270 W3A2a — Exercise catalog content/source integration](tnyx-270-w3a2a-exercise-catalog-content-integration.md) | In progress | `apps/features/workout` catalog data/source boundary | Sanitized/versioned bundled catalog, injected AssetBundle source and production-asset validation; no UI/routing/media/standards/icons |
| [TNYX-273 W3A2a-F1 — Post-merge catalog review fixes](tnyx-273-w3a2a-post-merge-review-fixes.md) | In progress | `apps/features/workout` catalog source + canonical docs | PR #340 in review (TNYX-273 `In Review`); PR #339 follow-up: stale docs (R4) and narrowed missing-asset classification (R5); no UI/routing/content change |
