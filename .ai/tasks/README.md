...
| [Product Onboarding Slice 2B — Target Weight + Goal Pace](product-onboarding-slice-2b-target-weight-goal-pace.md) | Blocked | `apps/features/onboarding` | Implementing goal-aware Target Weight/Goal Pace flow, recommendation, resume, validation, or measurement initialization after PR #50 |
