...
| [TNYX-201 B2 — HydrationPreferences composition split](tnyx-201-b2-hydration-preferences-composition.md) | In progress | `apps/app` composition root | GitHub #362; extract only Settings-owned HydrationPreferences providers while preserving `network_providers.dart` compatibility |
