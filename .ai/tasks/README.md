...
| [Workout Exercises presentation Library relocation](workout-exercises-library-presentation-relocation.md) | In review | `apps/features/workout` presentation | PR #352; path/ownership-only move from `presentation/explore/exercises` to `presentation/library/exercises`, with no UI/runtime change |
