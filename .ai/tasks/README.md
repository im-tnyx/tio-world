...
| [Product Onboarding structure and finalization](product-onboarding-structure-and-finalization.md) | Needs decision | onboarding orchestration + Profile/Body-Wellness/Nutrition/Workout/integration owners | Restructuring Product Onboarding sections, targets, Health Connections, Review, or Plan Building |
