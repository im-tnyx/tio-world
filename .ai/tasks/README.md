...
| [Product Onboarding Slice 2B — Target Weight + Goal Pace](product-onboarding-slice-2b-target-weight-goal-pace.md) | Blocked | `apps/features/onboarding` | Completing goal-aware Target Weight/Goal Pace after PR #50 is corrected, green, and merged |
