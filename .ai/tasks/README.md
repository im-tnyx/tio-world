...
| [TNYX-201 B3 — Workout composition split](tnyx-201-b3-workout-composition.md) | In progress | `apps/app` composition root | GitHub #365; extract Workout Profile + Workout Targets providers while preserving `network_providers.dart` compatibility |
