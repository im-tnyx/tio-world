...
| [TNYX-201 C2b2 — Product Onboarding route registration](tnyx-201-c2b2-onboarding-routes.md) | In progress | `apps/app` routing composition | GitHub #386 / #357; extract Product Onboarding/Congratulations route mounting while keeping workflow policy in root |
