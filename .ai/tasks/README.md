...
| [Workout Exercises presentation Library relocation](workout-exercises-library-presentation-relocation.md) | Validated | `apps/features/workout` presentation | Path/ownership-only move from `presentation/explore/exercises` to `presentation/library/exercises`; no UI/runtime change |
