...
**Status:** Dedicated Exercises screen implemented (W3A2b, TNYX-272) with no user-facing entry yet; detail, picker mode, Favorites/Custom/Folders and the Library entry remain planned.
