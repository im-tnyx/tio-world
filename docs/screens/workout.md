...
2. **Library** — one planned canonical Workout-owned route, first reached from a planned Workout Home entry, with capability-gated sections for Programs, Routines, Plans / Training Plans and Exercises. It is not a guided default tab or a Workout-local content tab; a future configurable navigation may promote the same route. See [Library](library.md).
